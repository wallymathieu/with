...
namespace Tests.Collections
{
    public class PairwiseTests
    {
        ...
        {
            var result = 0.To(4).Pairwise((i, i1) => (i,i1)); //TODO: Add overload next API version
        ...
        {
            var result = 0.To(3).Pairwise(Tuple.Create);
        ...
        {
            var result = 0.To(3).Pairwise((i, i1) => (i,i1)); //TODO: Add overload next API version
